...
const MODERN_CFO_PRESENTATION = "https://d2xsxph8kpxj0f.cloudfront.net/310519663493406861/AbQacd8d6pBJJuTzbrztLz/modern-cfo-presentation_5f36f152.jpg";
    ...
    <section className="bg-[#f8f7ff] py-20 lg:py-28">
      <AnimatedSection className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div variants={fadeUp}>
            <img src={MODERN_CFO_PRESENTATION} alt="CFO Moderno Presentando Resultados Financieros" className="w-full object-contain" />
          </motion.div>
        </div>
      </AnimatedSection>
    </section>
